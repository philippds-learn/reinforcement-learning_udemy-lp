...
from grid_world_session import standard_grid
...
if __name__ == '__main__':
	...
	# we will do this for both a unofirm random policy and fixed policy
	# NOTE:
	...
	# state will be positions (i,j)
	# simpler thatn tic-tac-toe because we only have one "game piece"
