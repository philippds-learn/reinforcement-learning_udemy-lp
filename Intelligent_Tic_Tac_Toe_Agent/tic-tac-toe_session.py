...
# possible states (as ints) and whi the corresponding winner is for those states (if any)
# (i, j) refers to the next cell on the board to permute (we need to try -1, 0, 1)
# impossible games are ignore, i.e. 3x's and 3o's in a row simultaneously
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # to go second you can switch the humand and AI
